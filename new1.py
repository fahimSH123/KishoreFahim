...
user_name=''
flag1 = 0
sender_email="fahim6083007@gmail.com"
reciver_email="fahim6083007@gmail.com"
def fun():
    record1=[]
...
contacts = ['fahim6083007@gmail.com', 'test@example.com']
...
with smtplib.SMTP_SSL('smtp.gmail.com', 465) as smtp:
    smtp.login(sender_email, "xvitxfdlfotocyza")
...
def sendemail(s_email,event,time):
    ...
    s.starttls()
    s.login(sender_email, "xvitxfdlfotocyza")
    text = msg.as_string()
    s.sendmail(reciver_email, s_email, text)
    s.quit()
...
def mailcheck():
    ...
    now = datetime.now()
    today=int(now.day)
    print(today,user_name)
    listItem=list(db[str(user_name)].find({'day':today}))
    print(listItem)
